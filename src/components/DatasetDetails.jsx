...
class DatasetDetails extends React.Component {
  ...
  componentDidMount() {
    ...
    axios.get("https://desuopendatabucket.s3-us-west-1.amazonaws.com/" + this.props.match.params.name + ".csv") 
        .then(result => {
          this.setState({
                  ...
                  <div className="datasetFacts">
                    <div>
                      ...
                      <div>
                        ...
                        <a href={"https://desuopendatabucket.s3-us-west-1.amazonaws.com/" + this.props.match.params.name + ".csv"} className="btnSecondary">Download CSV</a>
                      </div>
