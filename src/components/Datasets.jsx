...
class Datasets extends React.Component {
  ...
  componentDidMount() {
    axios.get('https://desuopendatabucket.s3-us-west-1.amazonaws.com/desu_metadata.json')
      .then(result => {
        this.setState({
          isLoaded: true,
    ...
    return (
      <div>
        <div className = "container">
            ...
            <h1>Datasets</h1>
            <p>The Delaware State University Open Data Portal (DeSODP) is a tool available for the public 
            where they can utilize our published data for both public and private use. Below feel free to utilize the search tool to quickly find specific datasets or use our filters to create subsections of data you are interested in.
            </p>
